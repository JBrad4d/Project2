...
MultiAgentJoystick::MultiAgentJoystick() {
    ...
    pub_command = n.advertise<geometry_msgs::Accel>("cmd_accel", 1);
}
...
bool MultiAgentJoystick::changeNamespace(bool decrement){
    ...
    if(new_namespace.compare(selected_namespace) == 0)
        ...
        std::string cmd_topic = "/" + selected_namespace + "cmd_accel";
        pub_command = n.advertise<geometry_msgs::Accel>(cmd_topic.c_str(), 1);
